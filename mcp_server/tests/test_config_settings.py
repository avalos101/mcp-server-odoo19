...
class TestConfigSettings(TransactionCase):
    ...
    def test_create_and_save_settings(self):
        ...
        self.assertEqual(param_obj.get_param("mcp_server.use_api_keys"), "False")
    ...
    def test_default_values(self):
        ...
        self.assertTrue(settings.mcp_use_api_keys)
