...
class ResConfigSettings(models.TransientModel):
    ...
    mcp_use_api_keys = fields.Boolean(
        string="Require API Keys",
        help="When enabled, all MCP API requests must include a valid API key for "
        "authentication. API keys can be generated for users in Settings > Users > "
        "API Keys. This provides secure access control and request attribution.",
        config_parameter="mcp_server.use_api_keys",
        default=True,
    )
    ...
    def get_values(self):
        ...
        res.update(
            ...
            mcp_use_api_keys=params.get_param("mcp_server.use_api_keys", "True") == "True",
    ...
    def set_values(self):
        ...
        params.set_param("mcp_server.use_api_keys", str(self.mcp_use_api_keys))
