#!/usr/bin/env python3
"""
Script de prueba para el servidor MCP de OmniERP
Ubicado en: prompts/test_omnierp_server.py

Este script prueba la conexión y realiza consultas al servidor MCP
configurado en https://omnierp.app/
"""
...
# Configuración del servidor OmniERP
ODOO_URL = "https://omnierp.app"
ODOO_DB = "omnierp.app"
ODOO_USER = "admin@omnierp.app"
ODOO_API_KEY = "7f3ea49d0339de71e39996866b61c26416ba0597"
...
def test_connection():
    ...
    print("=" * 60)
    print("PRUEBA 1: Conexión con OmniERP")
    print("=" * 60)
...
def main():
    """Función principal"""
    print("\n" + "=" * 60)
    print("PRUEBAS DEL CLIENTE MCP PARA OMNIIRP")
    print("=" * 60)
    print(f"\nConfiguración:")
    print(f"  URL: {ODOO_URL}")
    print(f"  Base de datos: {ODOO_DB}")
